...
exports.OVERVIEW_SYMBOLS = void 0;
exports.inferMarketQuery = inferMarketQuery;
exports.displayNameForSymbol = displayNameForSymbol;
exports.OVERVIEW_SYMBOLS = ["000001.SH", "399001.SZ", "399006.SZ"];
/**
...
function inferMarketQuery(messages) {
    ...
    if (!mentionsMarket && symbols.length === 0)
        return undefined;
    const overview = symbols.length === 0 && MARKET_OVERVIEW_INTENT.test(content);
    return {
        symbols: overview ? [...exports.OVERVIEW_SYMBOLS] : symbols.length > 0 ? symbols : ["000001.SH"],
        overview,
