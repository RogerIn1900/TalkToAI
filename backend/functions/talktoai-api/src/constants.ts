...
export const MAX_TEXT_ATTACHMENT_CONTEXT_BYTES = 64 * 1024;
...
export const DEEPSEEK_AI_MODEL = "deepseek-v4-flash";
export const DEEPSEEK_DIRECT_MODEL = "deepseek-flash";
export const DEEPSEEK_PROVIDER_DIRECT = "direct";
export const DEEPSEEK_PROVIDER_CLOUDBASE = "cloudbase";
export const SUPPORTED_AI_MODELS = new Set([DEFAULT_AI_MODEL, DEEPSEEK_AI_MODEL]);
